...
#gdalmerge -separate -o data/soc_031_population_grid.tif data/*_edit.tif

echo "mergevrt complete" >> status.txt

# or 
#gdalbuildvrt -separate -o soc_031_population_grid.vrt 
#data/GHS_POP_GPW41975_GLOBE_R2015A_54009_250_v1_0_edit.vrt 
#data/GHS_POP_GPW41990_GLOBE_R2015A_54009_250_v1_0_edit.vrt 
#data/GHS_POP_GPW42000_GLOBE_R2015A_54009_250_v1_0_edit.vrt 
#data/GHS_POP_GPW42015_GLOBE_R2015A_54009_250_v1_0_edit.vrt
